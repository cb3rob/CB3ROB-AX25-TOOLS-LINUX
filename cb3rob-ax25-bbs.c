...
//NO MORE SENDCLIENT HERE. WE'RE IN A REDIRECTED PTY WE CAN JUST PRINT TO STDOUT - IN FACT SENDCLIENT SEEMS TO BUFFEROVERFLOW IF THE SOCKET IS -1 ;p 'WHOOPS' ;)
//AAAND IT TURNS OUT THAT IF WE SEND \r TERMINATED LINE'S 'THEY'RE GONE JIM'.. TERMIOS IS DOING SOMETHING WEIRD. STILL. EVEN IF SET TO RAW.
//SEEMS LIKE SOME SORT OF CANONICAL MODE IS 'ON' EITHER WAY AS IT RECEIVES -NOTHING- FROM THE PTY!... INVESTIGATE... :P
