...
gcc -Wall -O3 -o cb3rob-ax25-bbs-login cb3rob-ax25-bbs-login.c
...
chown root.root cb3rob-ax25-bbs-login
...
chmod 710 cb3rob-ax25-bbs-login
...
killall -9 cb3rob-ax25-bbs-login
...
cp -v cb3rob-ax25-bbs cb3rob-ax25-bbs-login cb3rob-ax25-bridge cb3rob-ax25-getty cb3rob-axudp-attach cb3rob-kiss-tcp-attach cb3rob-kiss-tcp-multiplexer /usr/sbin
